...
<body class="text-[#030C11]">
    ...
    <header class="header-bg text-[#0B375B] shadow-lg">
        <div class="max-w-7xl mx-auto flex justify-between items-center py-6 px-8">
            <div class="flex items-center gap-4">
                <img src="https://via.placeholder.com/164x60" width="164" height="60" alt="NAPP Logo" class="h-12" />
            </div>
            <div class="flex items-center gap-6">
                <form class="max-w-lg mx-auto">
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-96 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
                        <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-[#D2C988] hover:bg-[#CAAF14] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
                    </div>
                </form>
                <button class="bg-[#239058] text-white px-5 py-2 rounded-lg shadow-lg hover:bg-[#1d7a47] transition duration-300">Войти</button>
                <button class="bg-[#D2C988] text-white px-5 py-2 rounded-lg shadow-lg hover:bg-[#CAAF14] transition duration-300">
    ...
    <section class="max-w-7xl mx-auto py-20 px-6 text-center">
        ...
        <p class="mt-6 text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Подать заявку на получение лицензии или разрешения стало проще — удобные сервисы, прозрачность и скорость обработки. Начните прямо сейчас!
        </p>
    </section>

    <!-- Cards -->
    <section class="max-w-7xl rounded-lg bg-white mx-auto px-10 py-10 grid md:grid-cols-2 lg:grid-cols-2 gap-8 px-6 mb-16">
        <p class="col-span-full justify-left pt-5 font-semibold text-lg text-[#0B375B] underline">Виды лицензий и разрешительных документов по направлениям</p>
        <div class="bg-white border border-[#0B375B]/20 rounded-2xl p-8 shadow-md card-hover">
            <h3 class="font-semibold text-xl text-[#D2C988]"><a href="#">Провайдеры услуг и оборот крипто-активов</a></h3>
            <p class="pt-5 font-semibold text-lg text-[#0B375B]"><a href="#">Майнинг</a> | <a href="#">Крипто-биржи</a> | <a href="#">Крипто-магазины</a></p>
        </div>
        <div class="bg-white border border-[#0B375B]/20 rounded-2xl p-8 shadow-md card-hover">
            <h3 class="font-semibold text-xl text-[#239058]"><a href="#">Рынок капитала</a></h3>
            <p class="pt-5 font-semibold text-lg text-[#0B375B]"><a href="#">Инвестиционные посредники</a> | <a href="#">Консультанты</a></p>
        </div>
        <div class="bg-white border border-[#0B375B]/20 rounded-2xl p-8 shadow-md card-hover">
            <h3 class="font-semibold text-xl text-[#D2C988]"><a href="#">Рынок страхования</a></h3>
            <p class="pt-5 font-semibold text-lg text-[#0B375B]"><a href="#">Страховая деятельность</a> | <a href="#">Перестрахование</a></p>
        </div>
        <div class="bg-white border border-[#0B375B]/20 rounded-2xl p-8 shadow-md card-hover">
            <h3 class="font-semibold text-xl text-[#D2C988]"><a href="#">Организации игр, основанных на риске (Гемблинг)</a></h3>
            <p class="pt-5 font-semibold text-lg text-[#0B375B]"><a href="#">Деятельность по организации лотерей</a> | <a href="#">Деятельность по организации игр, основанных на риске, во всемирной информационной сети Интернет</a> | <a href="#">Букмекерская деятельность</a></p>
        </div>
    </section>
    ...
    <section class="max-w-7xl rounded-lg bg-white mx-auto px-10 py-10 gap-8 px-6 mb-16">
        ...
        <div class="my-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="flex items-center gap-4">
                    <img src="https://img.icons8.com/ios-filled/50/0B375B/bitcoin.png" alt="Bitcoin Icon" class="w-12 h-12" />
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4">
                    <img src="https://img.icons8.com/ios-filled/50/0B375B/graph.png" alt="Capital Icon" class="w-12 h-12" />
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4">
                    <img src="https://img.icons8.com/ios-filled/50/0B375B/shopping-cart.png" alt="Commerce Icon" class="w-12 h-12" />
                    <div class="flex-1">
                ...
                <div class="flex items-center gap-4">
                    <img src="https://img.icons8.com/ios-filled/50/0B375B/dice.png" alt="Gambling Icon" class="w-12 h-12" />
                    <div class="flex-1">
    ...
    <script>
        ...
        const days = Array.from({ length: 12 }, (_, i) => `День ${i + 1}`);
        ...
        new Chart(document.getElementById('barChart'), {
            ...
            data: {
                labels: days,
                datasets: [
                    { label: 'Поступившие', data: datasetData.incoming, backgroundColor: '#239058' },
                    { label: 'На рассмотрении', data: datasetData.reviewing, backgroundColor: '#D2C988' },
                    { label: 'Отклоненные', data: datasetData.rejected, backgroundColor: '#DA484C' },
                    { label: 'Завершенные', data: datasetData.finished, backgroundColor: '#0B375B' }
                ]
            },
            options: {
                responsive: true,
                ...
                scales: {
                    x: { stacked: true, title: { display: true, text: 'Дни' } },
                    y: { stacked: true, beginAtZero: true, title: { display: true, text: 'Количество заявок' } }
                }
            }
        });
    </script>
